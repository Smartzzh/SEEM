...
from util.remote_sense_inferencer import RSImage, RSInferencer
from util.rgb2shape import tif_to_shapefile
...
def main():
    ...
    parser.add_argument('--stride',help='Window xstride, ystride',default=(768, 768),type=int,nargs=2)
    parser.add_argument(
