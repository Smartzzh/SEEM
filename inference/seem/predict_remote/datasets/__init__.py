...
from .landslide import LandSlideDataset
from .debrisflow import DebrisFlowDataset
# yapf: disable
...
from .gd_wy import GD_WYDataset
from .gid import GID_Dataset
...
__all__ = [
    ...
    'NYUDataset', 'HSIDrive20Dataset', 'LandSlideDataset', 'DebrisFlowDataset','GD_WYDataset',
    'GID_Dataset'
]
