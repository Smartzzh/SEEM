...
data_root = 'mydata/各区域采样/阿坝州'
dataset_type = 'LandSlideDataset'
default_hooks = dict(
...
launcher = 'none'
load_from = 'work_dirs/1125后结果/阿坝州/iter_6000.pth'
log_level = 'INFO'
...
visualizer = dict(
    name='visualizer',
    save_dir='work_dirs/1125后结果/阿坝州/vis_data',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = 'work_dirs/1125后结果/阿坝州'
