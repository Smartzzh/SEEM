...
def debrisflow_classes():
    """DebrisFlow class names for external use."""
    return [
        '背景', '建筑物', '沟道物源', '崩滑物源', '道路'
    ]
...
def landslide_classes():
    """Pascal VOC class names for external use."""
    return [
        'Background', 'LandSlide'
    ]

def landslide_palette():
    """landslide_palette for external use."""
    return [[0, 0, 0],[255, 0, 0]]

def debrisflow_palette():
    """debrisflow_palette for external use."""
    return [[0, 0, 0],[255, 0, 0],[0, 255, 0],[0, 0, 255],[255, 255, 0]]

def gdwy_classes():
    """gd_wy_classes for external use."""
    return [
        'background', '沟道物源'
    ]
def gdwy_palette():
    """gd_wy_palette for external use."""
    return [[0, 0, 0],[255, 0, 0]]
