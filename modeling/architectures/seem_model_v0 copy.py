...
class GeneralizedSEEM(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        # #加的AFPN
        # self.afpn = AFPN(in_channels = [96, 192, 384, 768])
    ...
    def prepare_targets(self, batched_inputs, images):
        ...
        for idx, batch_per_image in enumerate(batched_inputs):
            ...
            # # 获取不同的值
            # unique_values = torch.unique(padded_masks)
            # # 打印不同的值
            # print("不同的值有：", unique_values)
